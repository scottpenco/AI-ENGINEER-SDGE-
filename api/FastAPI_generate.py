...
app = FastAPI(
    title="Synthetic Tabular Generator",
    version="1.0.0",
    description="FastAPI wrapper around your DDPM tabular generator",
)
...
def generate_synthetic_endpoint(payload: GenerateRequest):
    try:
        ...
        return {
            "n_samples": payload.n,
            "saved": bool(out_path) and payload.save,
            "data": json.loads(df.to_json(orient="records")),
        }

    except Exception as e:
        # Wrap any internal errors as HTTP 500
